...
/**
 * The cart contains the orderLines of a customer that aren't bought yet
 */
@Getter
@Entity
public class Cart {
     ...
     * @param add      if true, the quantity will be added to the quantity if there is already an order line with the same product. If false the previous quantity will be overwritten
     */
     ...
     *
     * @param user the user who wants to check out
