...
class TestOrderLine
{
    ...
    void orderLineTotalPrice()
    {
        ...
        var ol = new OrderLine(RandomUtils.nextInt(), new Vendor(), String.valueOf(RandomUtils.nextInt()), new Product(RandomUtils.nextLong(1,100), RandomStringUtils.random(4), price, new Category(), new Vendor(), RandomStringUtils.random(4), new ArrayList<>(), new ArrayList<>()), quantity);
